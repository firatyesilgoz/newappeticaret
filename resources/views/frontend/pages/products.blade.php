              ...
              @if (!@empty($sizelist))
                @foreach ($sizelist as $sizelists)
                    <label for="s_sm" class="d-flex">
                        <input type="checkbox" id="s_sm" class="mr-2 mt-1"> <span class="text-black">{{$sizelists}}</span>
                    </label>
                @endforeach
            ...
            <div class="mb-4">
              ...
              @if (!@empty($colors))
                ...
                <a href="#" class="d-flex color-item align-items-center" >
                    <span class="bg-succes color d-inline-block rounded-circle mr-2"></span> <span class="text-black">{{$color}}</span>
                  </a>
                @endforeach
